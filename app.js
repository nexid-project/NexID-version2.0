...
const profileSectionTemplates = {
	...
	'social-buttons': () => `<section id="social-buttons-section" data-section="social-buttons" class="flex flex-wrap justify-center gap-3 draggable-item p-2"></section>`,
...
const socialIcons = {
	...
	github: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.49.5.092.682-.217.682-.482 0-.237-.009-.868-.014-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.031-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0 1 12 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.378.203 2.398.1 2.651.64.7 1.03 1.595 1.03 2.688 0 3.848-2.338 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.577.688.482A10.001 10.001 0 0 0 22 12c0-5.523-4.477-10-10-10z"></path></svg>`,
	linkedin: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>`,
	tiktok: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.01.96-.02 1.92-.02 2.88.02 1.66-.24 3.33-.81 4.91-1.64 4.64-6.02 7.2-10.63 6.9-3.46-.25-6.3-2.15-7.92-5.12-1.95-3.58-1.73-7.6-1.1-11.29.61-3.56 2.56-6.17 5.22-7.92 2.65-1.75 5.82-2.18 8.9-1.78.01 1.66.02 3.32.02 4.98zM12.14 4.03c-1.3-.01-2.59-.01-3.89-.02-1.18.43-2.25 1.13-3.12 2.05-.87.92-1.46 2.06-1.72 3.29-.26 1.23-.2 2.52.12 3.75.32 1.23.89 2.38 1.67 3.39.78 1.01 1.79 1.83 2.94 2.43.32.17.65.32.99.45.02-1.18.03-2.36.03-3.54.01-1.28-.2-2.57-.71-3.75-.51-1.18-1.26-2.2-2.23-2.98-.97-.78-2.16-1.29-3.4-1.49.02-1.66.02-3.32.02-4.98.43.01.86.02 1.29.02 1.31.01 2.61.01 3.92.01.01 1.67.01 3.33.02 5 .09.01.18.02.27.03.33.04.66.09.99.15.01-1.66.01-3.32.01-4.98z"/></svg>`,
	...
	whatsapp: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 4.315 1.731 6.086l.11.192-1.127 4.135 4.224-1.114.215.126zM12 6.907c-1.13 0-2.059.928-2.059 2.058 0 1.13.929 2.058 2.059 2.058s2.059-.928 2.059-2.058c0-1.13-.929-2.058-2.059-2.058zm0 10.181c-1.13 0-2.059-.928-2.059-2.058 0-1.13.929 2.058 2.059 2.058s2.059.928 2.059 2.058c0 1.13-.929 2.058-2.059 2.058z"/></svg>`,
	behance: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 0.72 0.72"><path d="M0.602 0.19H0.45v0.042h0.153ZM0.57 0.481a0.067 0.067 0 0 1 -0.039 0.011 0.067 0.067 0 0 1 -0.051 -0.016 0.075 0.075 0 0 1 -0.019 -0.053H0.66a0.195 0.195 0 0 0 -0.005 -0.06 0.153 0.153 0 0 0 -0.024 -0.052 0.126 0.126 0 0 0 -0.043 -0.036 0.132 0.132 0 0 0 -0.06 -0.013 0.147 0.147 0 0 0 -0.057 0.011 0.135 0.135 0 0 0 -0.044 0.03 0.132 0.132 0 0 0 -0.028 0.046 0.162 0.162 0 0 0 -0.01 0.057 0.165 0.165 0 0 0 0.01 0.058 0.135 0.135 0 0 0 0.026 0.046 0.12 0.12 0 0 0 0.044 0.03 0.156 0.156 0 0 0 0.058 0.01 0.143 0.143 0 0 0 0.079 -0.021 0.126 0.126 0 0 0 0.049 -0.07h-0.066a0.046 0.046 0 0 1 -0.019 0.023m-0.103 -0.124a0.056 0.056 0 0 1 0.03 -0.034 0.069 0.069 0 0 1 0.03 -0.006 0.052 0.052 0 0 1 0.041 0.015 0.087 0.087 0 0 1 0.019 0.043h-0.124a0.09 0.09 0 0 1 0.003 -0.018Zm-0.159 -0.014a0.092 0.092 0 0 0 0.038 -0.03 0.081 0.081 0 0 0 0.013 -0.047 0.099 0.099
0.003a0.691 0.691 0 0 0 -0.21 0l0.004 -0.001c-0.008 -0.019 -0.016 -0.034 -0.024 -0.049l0.001 0.002a0.003 0.003 0 0 0 -0.002 -0.001l0 0h0a0.738 0.738 0 0 0 -0.188 0.059l0.005 -0.002a0.003 0.003 0 0 0 -0.001 0.001C0.081 0.316 0.03 0.467 0.03 0.63q0 0.041 0.004 0.081l0 -0.003a0.003 0.003 0 0 0 0.001 0.002 0.738 0.738 0 0 0 0.219 0.112l0.005 0.001a0.003 0.003 0 0 0 0.001 0q0.002 0 0.002 -0.001a0.525 0.525 0 0 0 0.045 -0.072l0.001 -0.003a0.003 0.003 0 0 0 -0.002 -0.004h0a0.48 0.48 0 0 1 -0.073 -0.035l0.002 0.001a0.003 0.003 0 0 1 -0.001 -0.002c0 -0.001 0 -0.002 0.001 -0.002 0.005 -0.004 0.009 -0.007 0.014 -0.011a0.003 0.003 0 0 1 0.003 0h0c0.066 0.032 0.144 0.05 0.226 0.05s0.16 -0.019 0.229 -0.052l-0.003 0.001a0.003 0.003 0 0 1 0.003 0q0.007 0.006 0.014 0.011a0.003 0.003 0 0 1 0.001 0.002 0.003 0 0 1 -0.001 0.002c-0.02 0.012 -0.043 0.023 -0.067 0.032l-0.003 0.001a0.003 0.003 0 0 0 -0.002 0.003q0 0.001 0 0.001v0c0.015 0.029 0.03 0.053 0.047 0.076l-0.001 -0.002a0.003 0.003 0 0 0 0.003 0.001h0c0.086 -0.027 0.161 -0.065 0.227 -0.115l-0.002 0.001a0.003 0.003 0 0 0 0.001 -0.002c0.003 -0.024 0.004 -0.051 0.004 -0.078 0 -0.162 -0.051 -0.313 -0.139 -0.436l0.002 0.002a0.002 0.002 0 0 0 -0.001 -0.001z"/></svg>`,
	...
	soundcloud: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M24 13.151v-2.302c-1.96-.432-3.832-1.218-5.5-2.288 0-2.302 0-4.604 0-6.906h-1.053c-.313 2.995-1.258 5.83-2.73 8.339-2.04 3.551-5.12 5.928-8.717 6.661v-2.302c1.472-.432 2.817-1.134 4-2.057v-2.186c-1.183.432-2.438.734-3.75.864v-2.302c1.312-.13 2.567-.432 3.75-.864v-2.186c-1.183.432-2.438.734-3.75.864v-2.302c1.312-.13 2.567-.432 3.75-.864v-2.057c-2.375 1.068-4.247 2.76-5.5 4.928h-1.053c.21-3.855 1.555-7.452 3.803-10.364 2.248-2.912 5.228-4.782 8.497-5.288v16.398c2.567-1.488 4.538-3.657 5.5-6.364h1.053c-.19 2.535-.985 4.928-2.273 6.906 1.183.734 2.438 1.339 3.727 1.829z"/></svg>`,
	telegram: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7.253 8.216l-2.28 10.64-3.23-2.553-1.44 1.386c-.136.136-.315.204-.494.204-.06 0-.12-.01-.18-.028-.23-.063-.41-.22-.49-.44l-1.03-2.92 5.46-4.89-6.7 4.1-1.03-2.92c-.08-.22-.26-.377-.49-.44-.23-.063-.47-.028-.66.094l-1.22 1.13-1.44-1.386 19.32-7.304z"/></svg>`,
};
    ...
    socialCategories.forEach((category, index) => {
        ...
        category.socials.forEach(key => {
            ...
            if (mode === 'icons') {
                ...
                const preview = `<div class="social-button flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-lg ${info.bg} ${info.color}">${largeSocialIcons[info.key].replace(/width="24"/g, 'width="20"').replace(/height="24"/g, 'height="20"')}</div>`;
