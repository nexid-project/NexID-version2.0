...
function renderProfile(profileData, isOwner) {
	...
	const theme = profileData.theme || 'negro';
...
function enableFocusDrag(container, image, galleryImageData) {
    ...
    const onMouseDown = (e) => {
        ...
        const currentFocusY = parseFloat(image.style.objectPosition.split(' ')[1]) || 50;
        startFocusPercent = currentFocusY;
        lastFocusPercent = currentFocusY;
    ...
    const onMouseMove = (e) => {
        ...
        const maxDrag = (imageHeight - containerHeight);
        const dragPercent = (deltaY / maxDrag) * 100;
        
        let newFocusPercent = startFocusPercent - dragPercent;
